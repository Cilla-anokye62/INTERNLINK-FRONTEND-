...
export default function ChatScreen({ route, navigation }: any) {
  ...
  const renderSpecialMessage = (msg: ChatMessage) => {
    ...
    return (
      <View style={[styles.specialBubble, { backgroundColor: isOffer ? colors.offerCardBg : colors.iconCircle, borderLeftColor: isOffer ? colors.successIcon : colors.accent }]}>
        <Ionicons name={isOffer ? 'gift-outline' : 'calendar-outline'} size={16} color={isOffer ? colors.successIcon : colors.accent} />
